        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            >
                <div style={{ background: '#F8FAFC', padding: '24px', borderBottom: '1px solid #E2E8F0', textAlign: 'center' }}>
                    <div style={{ width: '64px', height: '64px', background: '#F0F9FF', color: '#0EA5E9', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', boxShadow: '0 4px 6px -1px rgba(14, 165, 233, 0.1)' }}>
                        <Shield size={32} />
                    </div>
                    <h3 style={{ fontSize: '1.25rem', fontWeight: 900, color: '#0F172A', marginBottom: '8px' }}>Security Check</h3>
