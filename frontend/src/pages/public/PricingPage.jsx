...
const PricingPage = () => {
    ...
    const plans = [
        {
            ...
            features: [
                ...
                "Dynamic Virtual Account Invoices",
    ...
    return (
        <div style={{ minHeight: '100vh', background: 'white', color: '#0F172A', fontFamily: "'Outfit', sans-serif" }}>
            ...
            {/* AI Call to Action */}
            <section style={{ padding: 'clamp(40px, 6vw, 80px) 24px', backgroundColor: '#FFFFFF', color: '#FFFFFF' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ position: 'relative', zIndex: 2, maxWidth: '800px', margin: '0 auto' }}>
                            <h2 style={{
                                ...
                                <span style={{ color: '#A78BFA' }}>Start With 14 Days Free.</span>
                            </h2>
                            ...
                            <p style={{
                                ...
                                Every new business gets 14 days of full Chairman access. No credit card required. No hidden commitments. Setup in 2 minutes.
                            </p>
