                ...
                <section style={{ marginTop: '120px', paddingBottom: '80px' }}>
                    ...
                    <div style={{ position: 'relative', paddingLeft: '40px', maxWidth: '800px', margin: '0 auto' }}>
                        ...
                        {[
                            ...
                            { date: "JAN '26 - JULY '26", title: "Pioneer Program", desc: "Onboarding our first 1,000 pioneers. Early access rewards and lifetime status for our founding merchants.", status: "active" },
                            { date: "AUGUST 1ST '26", title: "Global Public Launch", desc: "Opening the ecosystem for public merchant registration and global transactions. The OS for African commerce goes live.", status: "future" }
                        ].map((m, i) => (
                            <motion.div 
                                key={i}
